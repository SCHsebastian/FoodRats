...
class MealValueObjectsTest {
    @Test fun score_accepts_1_through_minotauro_6() {
        for (v in 1..6) assertTrue(Score.of(v) is Result.Ok)
    }
    @Test fun score_rejects_0_and_7() {
        assertTrue(Score.of(0) is Result.Err)
        assertTrue(Score.of(7) is Result.Err)
