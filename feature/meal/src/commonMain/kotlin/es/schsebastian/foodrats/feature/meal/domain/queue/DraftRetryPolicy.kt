...
/**
 * Pure retry/backoff policy for the offline-first publish queue (roadmap §5.2).
 *
 * Deterministic and side-effect-free so it can be unit-tested branch-by-branch
 * and shared verbatim by the Android WorkManager runner and the iOS background
 * task. Randomised jitter (if any) is the platform runner's concern — keeping
 * this policy deterministic is what makes it verifiable.
 *
