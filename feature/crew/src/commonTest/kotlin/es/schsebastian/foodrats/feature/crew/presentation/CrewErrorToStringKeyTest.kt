...
class CrewErrorToStringKeyTest {
    ...
    @Test fun backendUnknown() = assertEquals(CrewStringKey.ErrorUnknown, CrewError.Backend.Unknown.toStringKey())
    @Test fun sessionNotSignedIn() = assertEquals(CrewStringKey.ErrorSessionNotSignedIn, CrewError.Session.NotSignedIn.toStringKey())
    @Test fun sessionExpired() = assertEquals(CrewStringKey.ErrorSessionExpired, CrewError.Session.Expired.toStringKey())
    @Test fun inviteAlreadyRequested() = assertEquals(CrewStringKey.ErrorInviteAlreadyRequested, CrewError.Invite.AlreadyRequested.toStringKey())
    @Test fun transferCannotTransferToSelf() = assertEquals(CrewStringKey.ErrorTransferCannotTransferToSelf, CrewError.Transfer.CannotTransferToSelf.toStringKey())
