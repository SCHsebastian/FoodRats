...
import foodrats.feature.stats.generated.resources.stats_tag_variety_value
...
enum class StatsStringKey(override val resourceId: StringResource) : StringKey {
    ...
    TagVarietyLabel(Res.string.stats_tag_variety_label),
    TagVarietyValue(Res.string.stats_tag_variety_value),
